...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_waterscenestracking', default=True, help='val waterscenestracking')
    self.parser.add_argument('--test_waterscenestracking', default=True, help='test waterscenestracking')
